  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-8 no-scrollbar">
        ...
        {/* Heatmap & Activity Split */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-2 bg-white rounded-[2.5rem] border border-slate-200 p-8 shadow-sm h-[400px] flex flex-col">
              ...
              <div className="flex-1 rounded-[2rem] bg-slate-100 relative overflow-hidden border border-slate-200 group">
                {/* Simulated Heatmap */}
                <div className="absolute top-[40%] left-[30%] w-32 h-32 bg-rose-500/20 rounded-full blur-3xl animate-pulse"></div>
                <div className="absolute top-[60%] left-[70%] w-24 h-24 bg-violet-500/20 rounded-full blur-3xl"></div>
                
                {/* Simulated Map Markers */}
                <div className="absolute top-[35%] left-[25%] w-3 h-3 bg-rose-600 rounded-full ring-4 ring-rose-500/20"></div>
                <div className="absolute top-[65%] left-[75%] w-3 h-3 bg-violet-600 rounded-full ring-4 ring-violet-500/20"></div>
                
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                  <span className="text-[10px] font-black text-slate-300 uppercase rotate-45 opacity-20 text-4xl">Beasley Simulation</span>
                </div>
              </div>
           </div>
        ...
        {/* Predictive Layer - Using the existing logic but integrated here */}
